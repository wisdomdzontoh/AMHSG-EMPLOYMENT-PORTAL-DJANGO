...
class PostingPreferenceForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'first_choice_region': forms.Select(attrs={'class': 'form-control'}),
            'first_choice_facility': forms.Select(attrs={'class': 'form-control'}),
            'second_choice_region': forms.Select(attrs={'class': 'form-control'}),
            'second_choice_facility': forms.Select(attrs={'class': 'form-control'}),
            'third_choice_region': forms.Select(attrs={'class': 'form-control'}),
            'third_choice_facility': forms.Select(attrs={'class': 'form-control'}),
        }
